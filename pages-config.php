...
<head>
  ...
  <title>SmartSpot - Configuration</title>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <?php if ($user_type === 'admin'): ?>
                <!-- <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings">Parking Amount Settings</button>
                </li> -->
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#vehicle-type-settings">Vehicle Category Settings</button>
                </li>
                <?php endif; ?>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade" id="vehicle-type-settings">
                  <!-- Settings Form -->
                  <form id="vehicle-type">
                    <div class="row mb-3 mt-3">
                      <!-- Vehicle Type -->
                      <div class="col-md-4 mb-2">
                        <div class="input-group">
                          <span class="input-group-text">Vehicle Type</span>
                          <input name="vehicleType" type="number" class="form-control" id="vehicleType" required>
                      ...
                      <div class="col-md-4 mb-2">
                        <div class="input-group">
                          ...
                          <input name="vehicleTypeAmount" type="number" class="form-control" id="vehicleTypeAmount" required>
                          <!-- <span class="input-group-text"></span> -->
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 mb-2">
                        <div class="input-group">
                          <span class="input-group-text">Overtime Rate</span>
                          <input name="vehicleTypeOvertime" type="number" class="form-control" id="vehicleTypeOvertime" required>
                          <!-- <span class="input-group-text"></span> -->
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-center mb-3">
                      <button type="submit" class="btn btn-primary">Submit Vehicle Category</button>
                    </div>
                  </form>

                  <table id="vehicle-type-table" class="table table-hover table-bordered table-striped mt-3">
                    <thead>
                      <tr>
