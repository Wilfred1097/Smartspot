...
entry.place(x=85, y=40, width=320)  # Adjust the x, y, and width as needed
...
button3.place(x=410, y=40)

# Create button widgets
button = tk.Button(root, text="Open Coordinate Maker", command=open_coordinate_maker, font=("Arial", 10), width=18, activebackground="gray", activeforeground="white", relief="groove")
button.place(x=5, y=5)
button1 = tk.Button(root, text="Open Live Feed", command=open_live_feed, font=("Arial", 10), width=14, activebackground="gray", activeforeground="white", relief="groove")
button1.place(x=160, y=5)
button2 = tk.Button(root, text="Configure Database Connection", command=configure_database, font=("Arial", 10), width=23, activebackground="gray", activeforeground="white", relief="groove")
button2.place(x=283, y=5)
