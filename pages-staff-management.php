...
<head>
  ...
  <title>SmartSpot - Staff Management</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="dashbaord.php">
            ...
            <div class="card-body">
             <div class="row align-items-center">
                ...
                <div class="col-md-6 d-flex justify-content-end">
                  ...
                  <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">Add Staff</button>
                </div>
      ...
      document.getElementById('registrationForm').addEventListener('submit', function(event) {
          ...
          .then(data => {
              ...
              if (data.includes('Success!')) {
                  ...
                  Swal.fire({
                      title: "Success!",
                      text: "New parking staff added successfully!",
                      icon: "success"
                  }).then(() => {
                      // Refresh the page
                      location.reload();
              ...
              success: function(response) {
                  ...
                  if (result.success) {
                      ...
                      Swal.fire({
                          icon: 'success',
                          title: 'Success',
                          text: 'Staff account tatus updated successfully',
              ...
              trashIcon.onclick = function() {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          ...
                          Swal.fire(
                              'Deleted!',
                              'The Staff credentials has been deleted.',
                              'success'
                          );
                      } else if (result.isDismissed) {
                          Swal.fire(
                              'Cancelled',
                              'Staff account is safe.',
                              'info'
                          );
                      }
                  });
