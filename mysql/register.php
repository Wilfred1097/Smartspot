...
$sql = "INSERT INTO user (fname, mname, lname, address, gender, cont, email, password, otp, status, user_type)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$user_type = 'customer';
$stmt->bind_param("sssssssssss", $firstName, $middleName, $lastName, $address, $gender, $contactNumber, $email, $hashedPassword, $otp, $status, $user_type);
