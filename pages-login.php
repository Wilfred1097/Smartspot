        ...
        if ($user) {
            ...
            if ($user_type === 'admin') {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    setcookie('SmartSpot', $user_data, time() + 1 * 3600, '/');

                    // Start session and store user information
                    $_SESSION['user_email'] = $email;

                    // Redirect to admin dashboard
                    header("Location: dashboard.php"); // Assuming you have a separate dashboard for admin
                    exit;
                } else {
                ...
                if ($user['status'] === 'active') {
                    ...
                    if (password_verify($password, $user['password'])) {
                        ...
                        header("Location: dashboard.php"); // Assuming you have a separate dashboard for staff
                        exit;
                    } else {
                        $errorMessage = 'Invalid email or password.';
                    }
...
<head>
  ...
  <title>SmartSpot - Customer Login</title>
                ...
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <div class="row justify-content-center align-items-center">
                      <img src="assets/img/ss.png" alt="Logo" class="mb-2" style="width: 90px; height: auto;"/> 
                      <h6 class="text-center pb-0 fs-4">SmartSpot</h6>
                    </div>
