              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3" id="emailForm" novalidate method="POST">
                    ...
                    <div class="col-12">
                        <button class="btn w-100" style="background-color: #6600FF; color: white;" type="submit">Send OTP</button>
                    </div>
                    <div class="col-12 text-center">
                        <!-- <p class="small mb-0">Don't have an account? <a href="pages-register.php">Create an account</a></p><hr> -->
                        <p class="small mb-0">Go back to <a href="pages-login.php">Log in page</a></p>
                    </div>
                </form>
